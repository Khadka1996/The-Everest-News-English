...
const Lifestyle = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        setLoading(true);
        const response = await axios.get('https://potal.theeverestnews.com/api/english/category/lifestyle');
  ...
  return (
    <div className="mx-3 md:mx-10 lg:mx-18 py-6">
      <div className="mb-6 mt-2">
        <AdvertisementComponent position="english_lifestyle" />
      </div>
      ...
      {articles.length > 0 && (
        <div
          onClick={() => window.location.href = 'category/lifestyle'}
