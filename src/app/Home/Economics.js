  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        ...
        const response = await axios.get(`${API_URL}/api/english/category/economics?limit=6&sortBy=createdAt&sortOrder=desc`);
  ...
  return (
    <div className="mx-3 md:mx-10 lg:mx-18 py-6">
      <div className="mb-6 mt-2">
        <AdvertisementComponent position="english_economics" />
      </div>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="md:w-2/3 pr-4">
          ...
          {articles.length > 0 && (
            <div
              onClick={() => window.location.href = 'category/economics'}
