  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        ...
        const response = await axios.get(`${API_URL}/api/english/category/science?limit=6&sortBy=createdAt&sortOrder=desc`);
  ...
  return (
    <div className="mx-3 md:mx-10 lg:mx-18 py-6">
      <div className="mb-6 mt-2">
        <AdvertisementComponent position="english_science" />
      </div>
      ...
      {articles.length > 0 && (
        <div
          onClick={() => window.location.href = 'category/science'}
