  ...
  return (
    <div className="relative bg-gray-200 shadow-lg rounded-lg overflow-hidden">
      <div className="relative h-64">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black via-black/80 to-black/2">
  ...
  return (
    <div className="mx-3 md:mx-10 lg:mx-18 py-6">
      <div className="mb-6 mt-2">
        <AdvertisementComponent position="english_tourism" />
      </div>
      ...
      {articles.length > 0 && (
        <div
          onClick={() => window.location.href = 'category/tourism'}
